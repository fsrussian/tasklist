...
import ru.ageev.tasklist.backend.model.Status;
import ru.ageev.tasklist.backend.model.User;
import ru.ageev.tasklist.backend.repository.RoleRepository;
import ru.ageev.tasklist.backend.repository.UserRepository;
